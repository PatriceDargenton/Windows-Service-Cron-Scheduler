...
namespace murrayju.ProcessExtensions
{
    public static class ProcessExtensions
    {
        ...
        private static bool GetSessionUserToken(ref IntPtr phUserToken)
        {
            ...
            // For WTSQueryUserToken you will need the SE_TCB_NAME privilege,
            //  which is typically only held by Services running under the LocalSystem account.
            ...
            // See also:
            // https://stackoverflow.com/a/1289126/1872399
        ...
        public static bool StartProcessAsCurrentUser(string appPath, out string errMsg,
            string cmdLine = null, string workDir = null, bool visible = true)
        {
            ...
            try
            {
                if (!GetSessionUserToken(ref hUserToken))
                {
                    ...
                    // 27/04/2020 When user is not logged in, ignore visible task
                    errMsg = "Can't get user token";
                    return false;
                }
